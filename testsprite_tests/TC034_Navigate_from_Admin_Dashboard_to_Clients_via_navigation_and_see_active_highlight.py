...
async def run_test():
    ...
    try:
        ...
        # -> Type 'nandika' into the username field (element index 7), then type 'klp123' into the password field (index 8), then click the Sign in button (index 9).
        ...
        # -> Click the 'Clients' navigation link in the sidebar to navigate to the Clients page (/admin/clients).
        frame = context.pages[-1]
        # Click element
        ...
        await expect(frame.locator('xpath=//aside//nav//a[contains(normalize-space(.),"Clients") and (contains(@class,"active") or @aria-current="page")]').first).to_be_visible(timeout=3000)
