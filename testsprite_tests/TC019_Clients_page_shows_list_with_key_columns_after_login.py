...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Clients' link in the admin navigation to open Client Management (use element index 506).
        frame = context.pages[-1]
        # Click element
        ...
        elem = frame.locator('xpath=/html/body/div[2]/aside[1]/div/nav/div[2]/ul/li[3]/a').nth(0)
