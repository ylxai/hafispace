...
async def run_test():
    ...
    try:
        ...
        # -> Fill the username and password fields and click the Sign in button (input index 7 -> 'nandika', input index 8 -> 'klp123', then click index 9).
        ...
        assert await frame.locator('xpath=/html/body/div[2]/aside[1]/div/nav/div[2]/ul/li[3]/a').is_visible()
