...
async def run_test():
    ...
    try:
        ...
        # -> Type 'nandika' into the username field (element index 7).
        ...
        # -> Click 'Clients' in the admin navigation to open the Clients page.
        frame = context.pages[-1]
        # Click element
        ...
        # -> Click 'Clients' in the admin navigation to open the Clients page so the Add Client control can be located.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/aside/div/nav/div[2]/ul/li[3]/a').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
