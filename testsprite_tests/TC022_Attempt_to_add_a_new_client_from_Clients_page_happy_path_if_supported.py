...
async def run_test():
    ...
    try:
        ...
        # -> Type 'nandika' into the username field (index 7).
        ...
        # -> Click 'Clients' in the admin navigation to open the clients list.
        frame = context.pages[-1]
        # Click element
        ...
        await expect(frame.locator('text=Add Client').first).to_be_visible(timeout=3000)
